...
public class UsernameChecker {
    ...
    public static void main(String[] args) {
        ...
        checker.registerUser("Anushka", 101);
        checker.registerUser("Sample1", 102);
        checker.registerUser("Sample2", 103);

        System.out.println("Anushka available: " + checker.checkAvailability("Anushka"));
        System.out.println("Sample1 available: " + checker.checkAvailability("Sample1"));

        System.out.println("Suggestions for Anushka: " + checker.suggestAlternatives("Anushka"));

        checker.checkAvailability("Anushka");
